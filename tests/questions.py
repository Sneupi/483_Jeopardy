QA = [
	...
	("POTPOURRI, In 2011 bell ringers for this charity started accepting digital donations to its red kettle", ['The Salvation Army', 'Salvation Army']),
	...
	("HISTORICAL QUOTES, After the fall of France in 1940, this general told his country, \"France has lost a battle. But France has not lost the war\"", ['Charles de Gaulle', 'de Gaulle']),
	("STATE OF THE ART MUSEUM (Alex: We'll give you the museum. You give us the state.), The Taft Museum of Art", ['Ohio']),
	("CEMETERIES, The mast from the USS Maine is part of the memorial to the ship & crew at this national cemetery", ['Arlington National Cemetery', 'Arlington Cemetery']),
	("GOLDEN GLOBE WINNERS, In 2009: Joker on film", ['Heath Ledger']),
	("HISTORICAL HODGEPODGE, It was the peninsula fought over in the peninsular war of 1808 to 1814", ['Iberia', 'Iberian Peninsula']),
	("CONSERVATION, In 1980 China founded a center for these cute creatures in its bamboo-rich Wolong Nature Preserve", ['Panda', 'Giant panda']),
	...
	("CONSERVATION, Early projects of the WWF, this organization, included work with the bald eagle & the red wolf", ['World Wide Fund', 'World Wide Fund for Nature']),
	...
	("1920s NEWS FLASH!, Nov. 28, 1929! This man & his chief pilot Bernt Balchen fly to South Pole! Yowza! You'll be an admirable admiral, sir!", ['Richard Byrd', 'Richard E. Byrd']),
	...
	("AFRICAN-AMERICAN WOMEN, Bessie Coleman, the first black woman licensed as a pilot, landed a street named in her honor at this Chicago airport", ["O'Hare", "O'Hare International Airport"]),
	...
	("\"TIN\" MEN, He served in the KGB before becoming president & then prime minister of Russia", ['Vladimir Putin', 'Putin']),
	...
	("HISTORICAL QUOTES, In a 1959 American kitchen exhibit in Moscow, he told Khrushchev, \"In America, we like to make life easier for women\"", ['Richard Nixon', 'Nixon']),
	...
	("OLD YEAR'S RESOLUTIONS, Feb. 1, National Freedom Day, is the date in 1865 when a resolution sent the states an amendment ending this", ['Slavery', 'Slavery in the United States']),
	...
	("I'M BURNIN' FOR YOU, Pierre Cauchon, Bishop of Beauvais, presided over the trial of this woman who went up in smoke May 30, 1431", ['Joan of Arc', "Jeanne d'Arc"]),
	...
	("COMPLETE DOM-INATION(Alex: Not \"domination.\"), This New Orleans venue reopened Sept. 25, 2006", ['Mercedes-Benz Superdome', 'The Superdome']),
	...
	("HISTORICAL QUOTES, In 1888 this Chancellor told the Reichstag, \"we Germans fear God, but nothing else in the world\"", ['Otto von Bismarck', 'Von Bismarck']),
	...
	("NOTES FROM THE CAMPAIGN TRAIL, The Pulitzer-winning \"The Making of the President 1960\" covered this man's successful presidential campaign", ['JFK', 'John F. Kennedy']),
